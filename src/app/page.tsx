...
const FEATURED_PROJECTS = [
  ...
  {
    name: "SAVE - AI-Powered Personal Finance Platform",
    description:
      "Full-stack AI-powered personal finance platform where users can manage budgets, sync bank accounts via Plaid, scan receipts with Gemini AI, and receive automated financial insights.",
    points: [
      "Built a full-stack personal finance platform where users can manually create accounts or connect bank accounts through Plaid, manage budgets, and track and categorize transactions.",
      "Implemented automatic bank transaction syncing through Plaid, handling new, updated, and removed transactions while preventing duplicate records.",
      "Automated monthly financial reports summarizing income, expenses, net balance, and AI-generated spending insights via Gemini API, with 80% budget alerts scheduled through Inngest and delivered via Resend.",
      "Built AI-powered receipt scanning using Gemini API to extract transaction details from uploaded receipts, reducing manual entry to a two-click confirmation.",
      "Developed transaction analytics with Recharts, visualizing income, expenses, and net balance across 7-day, 1/3/6-month, and all-transaction views for each account, alongside a filterable transaction table.",
      "Implemented custom rate limiting to 5 transaction creations/minute using database-backed checks to prevent abuse.",
    ],
    stack: [
      "Next.js",
      "React",
    ...
    screenshots: [
      ...
      { src: "/save-overview.png", label: "Account Overview" },
    ],
  },
];
